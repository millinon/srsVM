...
#define REGISTER_OPCODE(c,n,argc_min,argc_max) do { \
    if(! register_opcode(loader, c, STR(n), argc_min, argc_max, EVAL3(conversion,n,WORD_SIZE), arg)){ \
        success = false; \
    } } while(0) ;
